  ...
  return (
    <div>
      <PageHeader
        ...
        description="Region → Sub-county → Ward structure with retail coverage. Zones act as sales territories."
        actions={
          <button
      ...
      <Card
        ...
        subtitle="Click a zone or sub-county to expand; coverage % shows share of registered outlets that are active."
        pad={false}
        actions={
