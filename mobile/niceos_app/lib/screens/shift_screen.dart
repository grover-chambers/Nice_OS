      ...
      children: [
        ...
        if (!clockedOut)
          AmberButton(
            ...
            onPressed: clockedIn
                ? () => context.read<ShiftProvider>().clockOut()
                : () => context.read<ShiftProvider>().clockIn(),
          )
        else
          AmberButton(
            'Clock in for a new shift',
            outlined: true,
            onPressed: () => context.read<ShiftProvider>().clockIn(),
          ),
        const SizedBox(height: 16),
        Text(
          gate
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(value, style: const TextStyle(fontFamily: Brand.fontMono, fontWeight: FontWeight.w800, color: Brand.ink)),
        ],
      ),
    );
  }
