              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: Icon(Icons.grid_view, color: index == 2 ? Brand.ink : Brand.paper, size: 26),
                  ),
          ...
          children: [
              ...
              child: Row(
                children: [
                  ...
                  const Column(
                    ...
                    children: [
                      Text('Nice OS', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: Brand.ink)),
            ...
            _DrawerTile(
              ...
              onTap: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Support: contact your route lead or the NiceOS admin desk.')),
                );
              },
            ),
          ],
