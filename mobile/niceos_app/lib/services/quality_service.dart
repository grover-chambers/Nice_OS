...
class QualityService {
  ...
  /// §5 GPS gate: fix accuracy worse than 15 m is a hard rejection.
  static const double gpsGateAccuracyM = 15;

  /// §5 Proximity: check-in further than 50 m from the outlet's stored GPS
  /// suggests the enumerator was not actually at the outlet.
  static const double proximityRadiusM = 50;

  /// §5 Speed flag: a full census visit under 4 minutes cannot have been done
  /// properly. Flag for back-check, do not reject (legitimately fast revisits
  /// exist).
  static const Duration minVisitDuration = Duration(minutes: 4);

  /// §5 Back-check: 5–10% of each enumerator's outlets re-visited weekly.
